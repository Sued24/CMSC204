...
public class MyStackTest {
	...
	public void testPopStudent() throws StackUnderflowException {
		try {
			assertEquals(6.1, doubleS.pop(), 0.01);
			assertEquals(1.2, doubleS.pop(), 0.01);
			assertEquals(3.5, doubleS.pop(), 0.01);
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		try {
			...
			assertEquals(true, doubleS.push(2.1));
			assertEquals(4, doubleS.size());
			assertEquals(true, doubleS.push(0.7));
	...
	@Test
	public void testTodoubleStudent() throws StackOverflowException
	{
		try 
		{
			assertEquals(3, doubleS.size());
			assertEquals(true, doubleS.push(0.2));
			assertEquals(4, doubleS.size());
			assertEquals(true, doubleS.push(0.04));
			assertEquals(5, doubleS.size());
			//Queue is full, next statement should cause QueueOverFlowException
			doubleS.push(4d);
		}
